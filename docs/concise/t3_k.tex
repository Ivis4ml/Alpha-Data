...
K2 & 分时频率异常 & $\displaystyle \big(c_t-\mu_{h(t)}\big)\big/\sigma_{h(t)},\quad c_t=\textstyle\sum_{u=t-59}^{t}\mathbf{1}\{|N1_u|>\kappa_u\}$ & 时序分桶：按小时分桶后标准化，剔除事件到达的日内季节性 \\
...
K8 & 方向一致率 & $\displaystyle \frac{U_{120}-D_{120}}{U_{120}+D_{120}},\ U_{120}=\textstyle\sum_{u=t-119}^{t}\mathbf{1}\{N1_u>\kappa_u\}$ & 2 小时窗内方向纯度，取值有界于 $[-1,1]$ \\
